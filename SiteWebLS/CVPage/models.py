...
class Project(models.Model):
    ...
    link = models.URLField("Lien vers le projet", max_length=100, null=True)
    photo = models.ImageField(
        'Photo du projet', upload_to=user_directory_path, max_length=100)
...
class Experience(models.Model):
    ...
    entreprise = models.CharField(
        "Nom de l'entreprise", max_length=50, null=True)
    ...
    def __str__(self):
        return 'Expérience en tant que ' + self.role + ' dans ' + self.entreprise
...
class Social(models.Model):
    ...
    link = models.URLField("Lien du réseau", max_length=100, null=True)
